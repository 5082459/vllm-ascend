#!/bin/bash
# Proxy startup script for DeepSeek-V4-Pro PD Disaggregation (1P1N 1D2N)
...
# PREFILLER_HOSTS format: P1N1_IP P1N1_IP
PREFILLER_HOSTS="192.168.1.20 192.168.1.20"
# PREFILLER_PORTS format: 7100 7101 for the node (vllm_start_port + dp_size_local - 1)
