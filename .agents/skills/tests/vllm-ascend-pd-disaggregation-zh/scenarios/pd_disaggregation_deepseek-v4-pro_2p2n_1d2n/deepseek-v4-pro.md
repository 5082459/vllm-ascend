# 测试用例：PD分离部署 - DeepSeek-V4-Pro (2P2N 1D2N)
...
- **输出目录名称使用：pd_disaggregation_deepseek_v4_pro_2p2n_1d2n**

## 测试场景

生成 DeepSeek-V4-Pro PD分离推理服务部署包（2个Prefill实例×2节点 + 1个Decode实例×2节点）。
...
| prefill_p1_n2_ip | 192.168.1.21 |
| prefill_p2_n1_ip | 192.168.1.22 |
| prefill_p2_n2_ip | 192.168.1.23 |
...
P1N2: kv_port=36000, engine_id=1, dp_rank_start=2
P2N1: kv_port=36000, engine_id=3, dp_rank_start=4
P2N2: kv_port=36000, engine_id=3, dp_rank_start=6
...
| 检查项 | P1N1 | P1N2 | P2N1 | P2N2 | D1N1 | D1N2 |
|---|---|---|---|---|---|---|
| kv_role | kv_producer | kv_producer | kv_producer | kv_producer | kv_consumer | kv_consumer |
| kv_port | 36000 | 36000 | 36000 | 36000 | 36200 | 36200 |
| engine_id | 1 | 1 | 3 | 3 | 2 | 2 |
| kv_connector | MooncakeHybridConnector | MooncakeHybridConnector | MooncakeHybridConnector | MooncakeHybridConnector | MooncakeHybridConnector | MooncakeHybridConnector |
| local_ip | 192.168.1.20 | 192.168.1.21 | 192.168.1.22 | 192.168.1.23 | 192.168.1.30 | 192.168.1.31 |
| --tensor-parallel-size | 8 | 8 | 8 | 8 | 8 | 8 |
| prefill.dp_size | 8 | 8 | 8 | 8 | 8 | 8 |
| decode.dp_size | 4 | 4 | 4 | 4 | 4 | 4 |

## Proxy 配置预期

分层版本 Proxy，hosts/ports 根据 dp_size_local 计算：
...
4. 验证 Prefill 实例包含 instance1/node1, node2 和 instance2/node1, node2
