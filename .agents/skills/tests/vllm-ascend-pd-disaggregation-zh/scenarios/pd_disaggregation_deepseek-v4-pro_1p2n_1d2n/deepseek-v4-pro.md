# 测试用例：PD分离部署 - DeepSeek-V4-Pro (1P2N 1D2N)
...
- **输出目录名称使用：pd_disaggregation_deepseek_v4_pro_1p2n_1d2n**

## 测试场景

生成 DeepSeek-V4-Pro PD分离推理服务部署包（1个Prefill实例×2节点 + 1个Decode实例×2节点）。
...
| 检查项 | Prefill Node 1 预期 | Prefill Node 2 预期 | Decode Node 1 预期 | Decode Node 2 预期 |
|---|---|---|---|---|
| kv_role | kv_producer | kv_producer | kv_consumer | kv_consumer |
| kv_port | 36000 | 36000 | 36200 | 36200 |
| engine_id | 1 | 1 | 2 | 2 |
| kv_connector | MooncakeHybridConnector | MooncakeHybridConnector | MooncakeHybridConnector | MooncakeHybridConnector |
| local_ip | 192.168.1.20 | 192.168.1.21 | 192.168.1.30 | 192.168.1.31 |
| --tensor-parallel-size | 8 | 8 | 8 | 8 |
| prefill.dp_size | 4 | 4 | 4 | 4 |
| decode.dp_size | 4 | 4 | 4 | 4 |
...
4. 验证 Prefill 实例包含 instance1/node1, node2
